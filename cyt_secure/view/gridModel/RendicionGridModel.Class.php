...
class RendicionGridModel extends GridModel {
	...
	public function RendicionGridModel() {
	...
	protected function initModel() {
		...
		$column = GridModelBuilder::buildColumn( "fecha", CYT_LBL_SOLICITUD_FECHA, 30, CDT_CMP_GRID_TEXTALIGN_CENTER, null, new GridDateValueFormat(CYT_DATETIME_FORMAT) ); 
		$this->addColumn( $column );
		...
		$column = GridModelBuilder::buildColumn( "observaciones", CYT_LBL_EVALUACION_OBSERVACIONES, 20, CDT_CMP_GRID_TEXTALIGN_LEFT, "observaciones");
		$this->addColumn( $column );
