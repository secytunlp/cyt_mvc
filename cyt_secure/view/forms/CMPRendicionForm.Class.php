...
class CMPRendicionForm extends CMPForm{
	...
	public function __construct($action="", $id="edit_rendicion") {
		...
		$input = FieldBuilder::buildFieldTextArea ( CYT_LBL_EVALUACION_OBSERVACIONES, "observaciones","","",8,100);
		...
		$this->addHidden( FieldBuilder::buildInputHidden ( "rendicion", "") );
		$this->addHidden( FieldBuilder::buildInputHidden ( "informe", "") );
		$this->addHidden( FieldBuilder::buildInputHidden ( "constancia", "") );
